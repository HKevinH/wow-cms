...
export class ContentApiModule {
  static register(pool: Pool) { return { module: ContentApiModule, controllers: [ContentController], providers: [{ provide: ContentService, useFactory: () => new ContentService(new MysqlPostRepository(pool)) }] }; }
}
