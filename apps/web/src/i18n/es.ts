...
export const es = {
  ...
  'account.donorPoints': 'Puntos de donación',
  'account.votePoints': 'Puntos de voto',
  'account.recharge': 'Recargar puntos',
  'store.title': 'Tienda',
  'store.disabled': 'La tienda no está disponible todavía.',
  ...
  'status.level': 'Nivel',
  'status.horde': 'Horda',
  'status.alliance': 'Alianza',
  'status.neutral': 'Neutral',
  'status.noPlayers': 'No hay jugadores conectados.',
