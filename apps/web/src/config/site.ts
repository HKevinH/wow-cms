...
export interface SiteConfig {
  ...
  readonly media: {
    ...
    readonly icons: Readonly<
      ...
      >
    >;
    readonly factions: Readonly<{ alliance: string; horde: string }>;
...
const THEME_MEDIA = "/media/themes/pandaria";
const CMS_MEDIA = "/media/cms";
...
export function getSiteConfig(): SiteConfig {
  return {
    ...
    media: {
      logo: { src: `${THEME_MEDIA}/brand/logo.png`, alt: "Mists of Pandaria" },
      hero: {
        ...
        sources: [
          { src: `${THEME_MEDIA}/hero/masthead-loop.webm`, type: "video/webm" },
          { src: `${THEME_MEDIA}/hero/masthead-loop.mp4`, type: "video/mp4" },
        ],
        poster: `${THEME_MEDIA}/hero/masthead.jpg`,
        posterMobile: `${THEME_MEDIA}/hero/masthead-mobile.jpg`,
      },
      featuresBackground: `${THEME_MEDIA}/panels/features.jpg`,
      featuresBackgroundMobile: `${THEME_MEDIA}/panels/features-mobile.png`,
      social: `${THEME_MEDIA}/social/og.jpg`,
      icons: {
        scenarios: `${THEME_MEDIA}/icons/scenarios.jpg`,
        challenges: `${THEME_MEDIA}/icons/challenges.jpg`,
        pets: `${THEME_MEDIA}/icons/pets.jpg`,
        dungeons: `${THEME_MEDIA}/icons/dungeons.jpg`,
        pandaren: `${THEME_MEDIA}/icons/pandaren.jpg`,
      },
      factions: {
        alliance: `${CMS_MEDIA}/factions/1.png`,
        horde: `${CMS_MEDIA}/factions/2.png`,
      },
      cards: {
        levelCap: `${THEME_MEDIA}/cards/level-cap.jpg`,
        talents: `${THEME_MEDIA}/cards/dungeons-and-raids.jpg`,
        timeless: `${THEME_MEDIA}/cards/celestial-difficulty.jpg`,
        alts: `${THEME_MEDIA}/cards/alt-friendly.jpg`,
        pandaren: `${THEME_MEDIA}/cards/pandaren.jpg`,
        launch: `${THEME_MEDIA}/cards/launch.jpg`,
      },
    },
